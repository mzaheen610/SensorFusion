...
class EKF2D:
    ...
    def calculate_jacobian(self, x, a, dt):
        ...
        # [FIX 1] Correct attitude derivative w.r.t gyro bias
                ...
                if len(angles) > 0:
                    ...
                    if ref_points is not None:
                        ...
                        if fitness < 0.3:
                            ...
                            # [FIX 2] Matrix math for Translation Lever Arm
                            corrected_xy = T_icp[:2, :2] @ pose[:2] + T_icp[:2, 2]
                    ...
                    # Reverted the broken random downsampler back to your original stable logic
